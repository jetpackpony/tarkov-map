  ...
  export interface Typegen0 {
        ...
        missingImplementations: {
          actions: "leftClick" | "panWithPointer" | "panWithTrackpad" | "pointerDown" | "pointerLeave" | "pointerMove" | "pointerUp" | "resetCanvas" | "zoomWithPinch" | "zoomWithTrackpad" | "zoomWithWheel";
          delays: never;
          guards: never;
          services: never;
        };
